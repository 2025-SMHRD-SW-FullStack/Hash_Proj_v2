...
const MyInfoPage = () => {
  ...
  return (
    <div className=" max-w-3xl mx-auto">
      <h1 className="hidden sm:block text-xl font-bold text-gray-800">내 정보 수정</h1>
        <div className='space-y-6'>
          ...
          <div className="flex justify-start">
              <Button size='md' onClick={() => setIsDeletionModalOpen(true)} className="bg-transparent text-gray-500 hover:text-red-500 underline border-none p-0">
              회원 탈퇴
              </Button>
          </div>
