  ...
  return (
    <div className="flex flex-col items-center px-4 pb-28 pt-8">
      ...
      <img
        ...
        alt="로고"
        onClick={goHome}
        className="block !h-10 w-[200px] max-w-none cursor-pointer select-none sm:!h-12" // ← 여기만 크기 조절
      />
      ...
      <form className="mx-auto w-full max-w-[960px]" onSubmit={handleSubmit}>
        ...
        <div className="mt-2">
          ...
          <div className="mt-1 flex flex-wrap items-center gap-2 md:flex-nowrap">
            ...
            <select
              className="select-basic w-36 shrink-0 rounded-l-none sm:w-40 md:w-44"
              value={selectedDomain}
          ...
          {emailError && (
            <span className="form-error">
              <img src={errorIcon} alt="에러 아이콘" className="mr-1.5 h-5" />
              {emailError}
            </span>
          )}
        </div>
        ...
        {phoneError && (
          <span className="mt-1 inline-flex items-center text-sm text-red-600">
            <img src={errorIcon} alt="에러" className="mr-1.5 h-5" />
            {phoneError}
          </span>
        )}
        ...
        {!phoneVerified && leftSec > 0 && (
          <div className="mt-2 flex flex-col gap-2 md:flex-row">
            ...
            <button
              type="button"
              className="h-11 rounded-xl border border-gray-200 bg-indigo-50 px-4 disabled:opacity-60"
        ...
        {phoneVerified && (
          <span className="mt-1 inline-flex items-center text-sm text-green-600">
            <img src={successIcon} alt="성공" className="mr-1.5 h-5" />
            휴대폰 인증이 완료되었습니다.
          </span>
        )}
        ...
        <p className="mb-2 text-sm text-gray-500">
          더욱 자연스럽고 개인 맞춤형 리뷰 생성을 원하시면, 아래 정보를
          입력해주세요.
        </p>
